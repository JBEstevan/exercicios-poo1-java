...
public class Notebook {
	...
	public int getQtdMemoriaRam() {
		return this.qtdMemoriaRam;
	}
	...
	public void setModeloProcessador(String novoProcessador) {
		this.modeloProcessador = novoProcessador;
	}

	public void setQtdMemoriaRam(int novaRam) {
		this.qtdMemoriaRam = novaRam;
	}

	public void setCapacidadeArmazenamento(int novoArmazenamento) {
		this.capacidadeArmazenamento = novoArmazenamento;
	}
}
